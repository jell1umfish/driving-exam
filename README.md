...
7. Нельзя удалить завершённое бронирование
...
Проект покрыт unit-тестами для бизнес-логики. Тесты не требуют запущенной базы данных.
...
**StudentService:**
- Создание студента — успешно
- Создание студента с дублирующимся ИИН — ошибка
- Получение студента по несуществующему ID — ошибка
- Получение студента по существующему ID — успешно

**ExamReservationService:**
- Создание бронирования — успешно
- Создание бронирования для несуществующего студента — ошибка
- Создание второго активного бронирования — ошибка
- Запись на практику без сданной теории — ошибка
- Отмена бронирования — успешно
- Отмена завершённого бронирования — ошибка
- Завершение бронирования — успешно